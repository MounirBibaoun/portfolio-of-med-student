...
export default function Home() {
  ...
  const galleryImages = [
    ...
    { id: 4, src: "/gallery/img10.jpg", alt: "Clinical practice" },
    { id: 5, src: "/gallery/img12.jpg", alt: "Study group" },
    { id: 6, src: "/gallery/img13.jpg", alt: "Study group" },
    { id: 7, src: "/gallery/img5.jpg", alt: "Study group" },
    { id: 8, src: "/gallery/img15.jpg", alt: "Study group" },
    { id: 9, src: "/gallery/img4.jpg", alt: "Study group" },
  ];
  const presentations = [
    {
      id: 1,
  ...
  return (
    <main className="min-h-screen relative bg-gradient-to-b from-pink-50 via-pink-100 to-pink-50 overflow-hidden">
      ...
      {[...Array(40)].map((_, i) => (
        <motion.div
          key={i}
          className={`absolute rounded-full bg-pink-200 opacity-${
            10 + Math.floor(Math.random() * 30)
          } w-${2 + Math.floor(Math.random() * 6)} h-${
      ...
      <section className="flex flex-col items-center mt-12 md:mt-16 text-center px-4 sm:px-6 lg:px-0 relative z-10">
        ...
        >
          Passionate medical student at{" "}
          <span className="font-semibold text-pink-600">UPSSA</span> exploring
          the world of medicine with{" "}
          <motion.span
        ...
        >
          ...
          >
            <div className="relative bg-white/30 backdrop-blur-lg rounded-full p-2 border border-white/40 shadow-2xl">
              ...
              {/* New floating icon */}
              <motion.div
                className="absolute -top-2 left-4 bg-white/90 backdrop-blur-sm rounded-full p-2 shadow-lg text-pink-600 text-sm border border-white/50"
                animate={{
                  y: [0, -8, 0],
                  x: [0, 5, 0],
                  scale: [1, 1.05, 1],
      ...
      <section
        id="journey"
        className="mt-16 max-w-6xl mx-auto px-4 sm:px-6 relative z-10"
      >
              ...
              <div className="space-y-6 relative z-10">
                ...
                >
                  <p className="text-pink-700 leading-relaxed text-lg">
                    I'm{" "}
                    <span className="font-bold text-pink-600 bg-pink-50 px-3 py-1 rounded-xl">
                      Derya
                    </span>
                    , a dedicated medical student at{" "}
                    ...
                    , pursuing my dream of becoming a compassionate healer.
                  </p>
                </motion.div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-pink-700 italic text-lg leading-relaxed">
                      "My fascination with medicine began with wonder about the
                      human body's incredible complexity and its capacity for
                      healing."
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="bg-white/60 rounded-xl p-4 text-center border border-pink-100">
                    <span className="text-2xl text-pink-600 mb-2 block">
                      💗
                    </span>
                ...
                >
                  <p className="text-pink-700 font-bold text-lg text-center">
                    I believe true healing combines{" "}
                    <span className="text-pink-600">medical excellence</span>{" "}
                    with{" "}
                    <span className="text-pink-600">genuine compassion</span>.
                  </p>
                </motion.div>
              </div>
            ...
            <div className="relative bg-gradient-to-br from-white via-pink-50 to-rose-50 rounded-3xl p-8 border border-pink-200/60 shadow-2xl hover:shadow-3xl transition-all duration-500 h-full overflow-hidden">
              ...
              >
                ...
                <p className="text-pink-600 text-sm">
                  Dedicated to ongoing learning and skill development in the
                  medical field.
                </p>
              </motion.div>
            </div>
      ...
      <section
        id="gallery"
        className="mt-16 max-w-4xl mx-auto px-4 sm:px-6 relative z-10"
      >
        <motion.div
     ...
     <section id="presentations" className="mt-20 max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
  <motion.div
    initial={{ opacity: 0, y: 30 }}
    whileInView={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.8 }}
  ...
  >
    ...
    <div className="text-center mb-12">
      ...
      <motion.p
        ...
        transition={{ delay: 0.3 }}
      >
        Explore my research projects and academic presentations in medical sciences
      </motion.p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      {presentations.map((presentation, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-pink-200 via-rose-100 to-pink-100 rounded-3xl blur-lg opacity-0 group-hover:opacity-60 transition-all duration-500" />
          
          {/* Main Card */}
          <div className="relative bg-gradient-to-br from-white via-pink-50 to-rose-50 rounded-3xl p-6 border-2 border-pink-200/60 shadow-xl hover:shadow-2xl transition-all duration-500 h-full overflow-hidden">
            
            {/* Animated Border */}
            <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-pink-400 via-rose-400 to-pink-400 opacity-0 group-hover:opacity-20 transition-opacity duration-500" />
            
            {/* Header with Icon */}
            <div className="flex items-start gap-4 mb-4">
              <motion.div
                className="relative bg-gradient-to-br from-pink-300 to-rose-400 p-4 rounded-2xl shadow-lg flex-shrink-0"
                whileHover={{ scale: 1.1, rotate: 5 }}
                transition={{ type: "spring", stiffness: 300 }}
              >
                <span className="text-2xl">{presentation.icon}</span>
                <motion.div
                  className="absolute -inset-1 bg-pink-400 rounded-2xl blur-md opacity-50 -z-10"
                  animate={{ scale: [1, 1.1, 1] }}
                  transition={{ duration: 3, repeat: Infinity }}
                />
              </motion.div>
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-xl font-bold text-pink-700 mb-2 group-hover:text-pink-800 transition-colors line-clamp-2">
                  {presentation.title}
                </h3>
            ...
            {/* Description */}
            <motion.p
              className="text-pink-600 leading-relaxed mb-4 text-sm line-clamp-3"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              transition={{ delay: 0.2 }}
            >
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {presentation.tags.map((tag, tagIndex) => (
                <motion.span
                  key={tagIndex}
                  className="px-3 py-1 bg-gradient-to-r from-pink-100 to-rose-100 text-pink-700 rounded-full text-xs font-medium border border-pink-200/60 shadow-sm hover:shadow-md transition-all duration-300"
            ...
            <motion.div
              ...
              transition={{ delay: 0.3 }}
            >
              <button className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-400 to-rose-500 text-white rounded-full text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group/btn">
            ...
            {/* Floating Elements */}
            <motion.div
              className="absolute top-4 right-4 text-pink-300/40 text-xl"
    ...
    <motion.div
      ...
      transition={{ delay: 0.5 }}
    >
      <button className="bg-gradient-to-r from-pink-500 to-rose-600 text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            >
              ...
              <p className="text-pink-600 leading-relaxed">
                Passionate medical student dedicated to healing with compassion
                and making a difference in healthcare.
              </p>
            </motion.div>
